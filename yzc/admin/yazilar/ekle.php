...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $yazisira=$conn->yazisirabul();
    $sira=$yazisira['sira']+1;
    ...
    <div>
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h4 class="m-0 font-weight-bold text-black">Yazı Ekle</h4>
            </div>
            <div class="card-body">
